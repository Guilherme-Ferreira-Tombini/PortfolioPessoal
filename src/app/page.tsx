   ...
   <div className="flex flex-row w-screen h-screen">
    {/* Menu em componente */}
     ...
     <div className="w-[100%] h-[100vh] flex flex-col justify-center items-center">
       ...
       <Image id="nuvem1" className="absolute right-0 top-0" src={Nuvem_superior} alt="Nuvem superior da pagina"/>

      {/* Texto referente a apresentação do portfolio  */}
       <Texto/>

      {/* Nuvem de efeito da pagina - Inferior */}
       <Image id="nuvem1" className="absolute left-[88px] bottom-0" src={Nuvem_inferior} alt="Nuvem inferior da pagina"/> 
